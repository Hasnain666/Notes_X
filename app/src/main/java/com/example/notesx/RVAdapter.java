...
import com.example.notesx.databinding.EachRvBinding;
...
public class RVAdapter extends ListAdapter<Note,RVAdapter.viewHolder> {
    ...
    private static final DiffUtil.ItemCallback<Note> CALLBACK = new DiffUtil.ItemCallback<Note>() {
        ...
        public boolean areContentsTheSame(@NonNull Note oldItem, @NonNull Note newItem) {
            return oldItem.getTitle().equals(newItem.getTitle()) && oldItem.getDiscription().equals(newItem.getDiscription());
        }
    };
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.binding.titleoutput.setText(note.getTitle());
        holder.binding.descriptionoutput.setText(note.getDiscription());
